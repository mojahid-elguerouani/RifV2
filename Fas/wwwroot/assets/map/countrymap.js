...
var simplemaps_countrymap_mapinfo = {
    ...
    default_labels: {},
    proj_coordinates: [
        { x: 90.9, y: 750.8, lat: 17.158477, lng: 35.626005 },
        { x: 545.5, y: 460.7, lat: 23.458633, lng: 46.158405 },
        { x: 909.1, y: 77.4, lat: 31.333828, lng: 54.584325 },
    ],
};
        ...
        function oa(e) {
            ...
            for (var i in ((tr = function (e) {
                var i = !ts[e],
                    ...
                    l = i ? ez.path(r) : ts[e];
                i && (l.sm = { id: e }), er || l.node.setAttribute("class", "sm_state sm_state_" + e) || l.node.setAttribute("onclick", "func_" + e+"()");
