    ...
    this.each(function() {
      ...
      <div class="imageuploadify well">
        ...
        <div class="imageuploadify-images-list text-center">
          ...
          <span class='imageuploadify-message'>اسحب ملفاتك هنا لتحميلها</span> 
           
        <button type="button" class="btn btn-default" style="background: white; color: rgb(58, 160, 255); pointer-events: initial;">أو اختار ملف محدد</button>
        </div>
      </div>
      `);
