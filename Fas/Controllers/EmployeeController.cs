...
namespace FasDemo.Controllers
{
    ...
    public class EmployeeController : Controller
    {
        ...
        public async Task<IActionResult> SubmitForm([Bind(
            ...
            "SystemUserId",
            "BenefitTemplateId"
            )]Employee employee, IFormFile logoPostedFileBase)
        {
            try
            {
                ...
                if (employee.EmployeeId == null)
                {
                    ...
                    {
                        TempData[StaticString.StatusMessage] = "خطأ: لا يمكن تكرار رقم معرف الموظف . " + employee.EmployeeIDNumber;
                        return RedirectToAction(nameof(Form), new { id = employee.EmployeeId ?? "" });
                    }
                    ...
                    {
                        TempData[StaticString.StatusMessage] = "خطأ: تم استخدام حساب المستخدم بالفعل  لمستخدم اخر. " + employee.SystemUserId;
                        return RedirectToAction(nameof(Form), new { id = employee.EmployeeId ?? "" });
                    }
                    ...
                    if (logoPostedFileBase != null && logoPostedFileBase.Length > 0)
                    {
                        var path = Path.Combine(
                         Directory.GetCurrentDirectory(), "wwwroot/UploadedFiles/Users/" + newEmployee.EmployeeId,
                         logoPostedFileBase.FileName);
                        string strMappath = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot/UploadedFiles/Users/" + newEmployee.EmployeeId);
                        ...
                        employee.ProfilePicture = $"UploadedFiles/Users/{newEmployee.EmployeeId}/" + logoPostedFileBase.FileName;
                    }
                    else
                    {
                    ...
                    newEmployee.ProfilePicture = employee.ProfilePicture;
                ...
                if (editEmployee != null)
                {
                    ...
                    {
                        var path = Path.Combine(
                         Directory.GetCurrentDirectory(), "wwwroot/UploadedFiles/Users/" + employee.EmployeeId,
                         logoPostedFileBase.FileName);
                        string strMappath = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot/UploadedFiles/Users/" + employee.EmployeeId);
                        ...
                        employee.ProfilePicture = $"UploadedFiles/Users/{employee.EmployeeId}/" + logoPostedFileBase.FileName;
                    }
                    else
                    {
                        employee.ProfilePicture = employee.ProfilePicture;
                    ...
                    editEmployee.ProfilePicture = employee.ProfilePicture;
        ...
        public IActionResult SubmitDelete([Bind("EmployeeId")] Employee employee)
        {
            try
            {
                ...
                TempData[StaticString.StatusMessage] = "تم حذف الموظف بنجاح";
        ...
        public async Task<IActionResult> SubmitDesignationForm([Bind("DesignationId", "Name", "Description")] Designation designation)
        {
            try
            {
                ...
                if (designation.DesignationId == null)
                {
                    ...
                    {
                        TempData[StaticString.StatusMessage] = "خطأ: " + designation.Name + " موجود مسبقا";
                        return RedirectToAction(nameof(DesignationForm), new { id = designation.DesignationId ?? "" });
                    }
        ...
        public async Task<IActionResult> SubmitDepartmentForm([Bind("DepartmentId", "Name", "Description")] Department department)
        {
            try
            {
                ...
                if (department.DepartmentId == null)
                {
                    ...
                    {
                        TempData[StaticString.StatusMessage] = "خطأ: " + department.Name + " موجود مسبقا";
                        return RedirectToAction(nameof(DepartmentForm), new { id = department.DepartmentId ?? "" });
                    }
