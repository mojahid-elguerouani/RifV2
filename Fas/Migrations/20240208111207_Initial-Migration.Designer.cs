...
namespace Fas.Migrations
{
    ...
    [Migration("20240208111207_Initial-Migration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectManagment.Models.Project", b =>
                {
                    ...
                    b.Property<string>("ProjectProgramId")
                        .IsRequired();
            ...
            modelBuilder.Entity("ProjectManagment.Models.ProjectManagementConsultant", b =>
                {
                    b.Property<string>("ProjectManagementConsultantId")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<string>("ProjectManagementConsultantName")
                        .IsRequired()
                        .HasMaxLength(50);
                    ...
                    b.HasKey("ProjectManagementConsultantId");

                    b.HasIndex("CreatedById");

                    b.HasIndex("UpdatedById");

                    b.ToTable("ProjectManagementConsultants");
                });

            modelBuilder.Entity("ProjectManagment.Models.ProjectProgram", b =>
                {
                    b.Property<string>("ProjectProgramId")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<string>("ProjectProgramName")
                        .IsRequired()
                        .HasMaxLength(50);
            ...
            modelBuilder.Entity("ProjectManagment.Models.SupervisionConsultant", b =>
                {
                    b.Property<string>("SupervisionConsultantId")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<string>("SupervisionConsultantName")
                        .IsRequired()
                        .HasMaxLength(50);
                    ...
                    b.HasKey("SupervisionConsultantId");

                    b.HasIndex("CreatedById");

                    b.HasIndex("UpdatedById");

                    b.ToTable("SupervisionConsultants");
                });
            ...
            modelBuilder.Entity("ProjectManagment.Models.Project", b =>
                {
                    ...
                    b.HasOne("ProjectManagment.Models.ProjectManagementConsultant", "ProjectManagementConsultant")
                        .WithMany("Projects")
                        .HasForeignKey("ProjectManagementConsultantId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("ProjectManagment.Models.ProjectProgram", "ProjectProgram")
                        .WithMany("Projects")
                        .HasForeignKey("ProjectProgramId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("ProjectManagment.Models.SupervisionConsultant", "SupervisionConsultant")
                        .WithMany("Projects")
